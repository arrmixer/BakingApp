...
public class StepFragment extends Fragment {
    ...
    private static final String EXTRA_PLAYBACK_POSITION = "package com.ae.andriod.bakingapp.view.extra.playback.position";
    private static final String EXTRA_PLAYER_WHEN_READY = "package com.ae.andriod.bakingapp.view.extra.player.when.ready";
    //placeholders
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putBoolean(EXTRA_PLAYER_WHEN_READY, playWhenReady);
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            playWhenReady = savedInstanceState.getBoolean(EXTRA_PLAYER_WHEN_READY);
        } else {
