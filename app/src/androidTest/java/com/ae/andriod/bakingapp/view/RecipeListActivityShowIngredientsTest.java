...
public class RecipeListActivityShowIngredientsTest {
    ...
    /*This test is to make sure once a recipe is clicked the first
    * Card View should display the title "Ingredients" */
    @Test
    public void recipeListActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.txt_ingredients), withText("Ingredients"),
                        childAtPosition(
                                childAtPosition(
